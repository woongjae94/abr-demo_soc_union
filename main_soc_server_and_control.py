...
if __name__ == '__main__':
    ...
    while True:
        ...
        if (now_time - prev_time) > 500:
            ...
            try:
                requests.get('http://192.168.0.22:3001/api/v1/actions/action/{}/Mode:{}_Gesture:{}_Action:{}_Head:{}_Device:{}'.format('home', control_mode, gesture_msg, action_msg, head_msg, device))
                print('Gesture: ',gesture_msg,' |Action: ', action_msg,' |Head: ', head_msg, ' |Device: ', device)
            except:
